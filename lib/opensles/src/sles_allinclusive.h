...
#ifndef __cplusplus
// devkitA64/newlib provides stdbool; rolling our own collides with it
#include <stdbool.h>
#endif
...
#ifdef LSWTCS
#ifdef __SWITCH__
// Switch build: stand-ins for the Vita types/clock used by the LSWTCS additions
#include <stdint.h>
typedef uint32_t SceUInt32;
extern SceUInt32 sceKernelGetProcessTimeLow(void); // usec clock, see sl_switch.c
#else
...
extern void IBufferQueue_InitHeaders(IBufferQueue *this);
extern void IBufferQueue_FreeBufferHeader(BufferHeader *header);
extern void IBufferQueue_ReleaseBufferHeader(BufferHeader *header);
extern void IBufferQueue_FreeOwnedBuffers(IBufferQueue *this);
